...
import (
	"github.com/mrlaojia/go-eureka/cmd/heartbeat"
	"github.com/mrlaojia/go-eureka/cmd/info"
	"github.com/mrlaojia/go-eureka/cmd/register"
	"github.com/mrlaojia/go-eureka/cmd/remove"
	"github.com/mrlaojia/go-eureka/cmd/set"
	"github.com/mrlaojia/go-eureka/cmd/status"
	"log"
	"os"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&eurekaHost, "eureka", "e", "", "必须，eureka服务器地址，如 10.0.199.177:8080")
	...
	rootCmd.AddCommand(heartbeat.HeartbeatCmd)
